# Generated by Powerlevel10k configuration wizard on 2020-09-09 at 16:25 JST.
...
() {
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=13
  ...
  ####################################[ date: current date ]####################################
  # Current date color.
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=6
  # Format for the current date: 2020-09-09. See `man 3 strftime`.
